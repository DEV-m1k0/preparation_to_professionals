# Generated by Django 4.2.16 on 2025-02-26 08:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_sub_division', models.ManyToManyField(blank=True, to='models.subsubdivision')),
            ],
        ),
        migrations.CreateModel(
            name='Organization',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=255)),
                ('subdivisions', models.ManyToManyField(blank=True, related_name='subdivisions', to='models.subdivision')),
            ],
        ),
        migrations.CreateModel(
            name='Material',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('responsible_worker', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='responsible_workers', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
